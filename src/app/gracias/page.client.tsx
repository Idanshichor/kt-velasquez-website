...
export default function GraciasPageClient() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-brand-cream)] text-[var(--color-brand-black)] flex flex-col">
      ...
      <main className="flex-grow pt-36 pb-24 px-6 md:px-16 flex items-center justify-center">
        <div className="max-w-2xl w-full bg-white rounded-[2.5rem] p-8 md:p-16 shadow-elevated border border-gray-100/50 text-center relative overflow-hidden">
          ...
          {language === "es" ? (
            <div>
              ...
              <p className="font-body text-base md:text-lg text-[var(--color-brand-gold)] font-bold mb-6">
              ...
              {/* Steps Box */}
              <div className="bg-gray-50 rounded-3xl p-6 md:p-8 text-left border border-gray-100 mb-8">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4 items-start">
                    <div className="w-6 h-6 rounded-full bg-[var(--color-brand-gold-light)] text-[var(--color-brand-black)] flex items-center justify-center text-xs font-black shrink-0 mt-0.5">
                      1
                    </div>
                    <div>
              ...
              <div className="pt-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20ba5a] text-white px-8 py-3.5 rounded-full font-bold uppercase tracking-widest text-[10px] transition-colors cursor-pointer"
                >
